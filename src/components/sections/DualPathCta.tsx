...
export default async function DualPathCta() {
  ...
  return <section className="border-b border-ink/10"><div className="grid md:grid-cols-2">
    <Link href="/locations" className="group px-8 py-16 md:py-20 border-b md:border-b-0 md:border-r border-ink/10 hover:bg-navy transition-colors">
    ...
    <Link href="/confier-mon-bien" className="group px-8 py-16 md:py-20 hover:bg-navy transition-colors">
